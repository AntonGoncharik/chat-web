        ...
        <>
          ...
          <Message>
            <Container className='auth__buttons_link'>
              ...
              <ButtonLink lable='I do not have account' onClick={() => props.changeCurrentPage(1)} />
            </Container>
          </Message>
        ...
        <>
          <Form size='large'>
            <Segment>
              ...
              <Form.Input fluid icon='user' iconPosition='left' placeholder='Code' />
              <Form.Input
                fluid
                icon='lock'
                iconPosition='left'
          ...
          <Message>
            <Container className='auth__buttons_link'>
              ...
              <ButtonLink lable='I have account' onClick={() => props.changeCurrentPage(0)} />
            </Container>
          </Message>
        </>
      }
